...
'.strip
  ...
  describe '#draw_dot' do
    ...
    context 'when the any of the specified pixel is out of range ' do
      ...
      it 'prints the error message' do
        expect { subject }.to output(
          'Specified X(2:2) and Y(6:6) is out of the range ' \
            "of the bitmap (3 x 5)\n"
        ).to_stdout
      end
    ...
    context 'when all the specified pixels are inside the range' do
...
'.strip
  ...
  describe '#draw_vertical_line' do
    ...
    subject do
      described_instance.draw_vertical_line(x, starting_y, ending_y, 'X')
    end
    ...
    context 'when the any of the specified pixel is out of range' do
      ...
      it 'prints the error message' do
        expect { subject }.to output(
          'Specified X(2:2) and Y(2:6) is out of the range ' \
            "of the bitmap (3 x 5)\n"
        ).to_stdout
      end
...
'.strip
  ...
  describe '#draw_horizontal_line' do
    ...
    context 'when the any of the specified pixel is out of range' do
      ...
      it 'prints the error message' do
        expect { subject }.to output(
          'Specified X(1:4) and Y(4:4) is out of the range ' \
            "of the bitmap (3 x 5)\n"
        ).to_stdout
      end
